...
int main() {
  ...
  return image->bss.begin == 0x80066ED8u && image->bss.end == 0x8006D264u &&
                 image->globalPointer == 0x80066D38u && image->libcInitEntry == 0x8005ABD8u &&
                 image->gameMainEntry == 0x80011ADCu && image->crt0Entry == 0x8005478Cu &&
                 image->residentText.begin == 0x00010000u &&
