...
| Past the splash | — | 🔬 | Guest stops presenting. 4-sample profile: `func_800163E4` <- `80016500` <- `8001250C` <- `800127C0` <- main, writing memory heavily. Unknown if slow-but-legit init or a spin. |
