...
//     diagnostic this port has. Stealing that handler to flush a DB would trade a hang diagnosis
//     for a report, and `producer_db_finish` is not async-signal-safe anyway (it `fopen`s, formats,
