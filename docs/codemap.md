...
| Paired player geometry | Layer pose decoding, transform construction, primitive/material resolution, and compatible temporal replay | `game/render/paired_actor_pose.*`, `paired_actor_decode.*`, `fx_paired_actor.*`, `paired_actor_temporal_evidence.*` | `spyro_paired_actor_submit`, `spyro_paired_actor_rebuild_endpoint` | `docs/re-frontier.md` |
