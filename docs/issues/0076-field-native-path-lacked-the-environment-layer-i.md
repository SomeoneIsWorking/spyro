...
This resolves the missing caller-contract owner, not the environment geometry. Applying the measured
invocation to the existing semantic world recipe exposed issue 0077, so no FIELD submitter is wired.
