// fx_title_menu.cpp — native front-end sprite layer of stage 13.
//
...
//
// ────────────────────────────────────────────────────────────────────────────────────────────────
// Historical binary analysis used Ghidra headless over
...
// or GP0 packet is inspected, and no guest renderer runs to make this picture.
//
// WHAT IS *NOT* PORTED, stated here rather than discovered later:
//   * Mode 2 of 0x8007CEE4 (the 3-slot save screen). Mode 1's memory-card pages are rendered
...
//
// This producer reads title state and sprite/style tables and writes only the native render queue.
